...
export default function Navbar() {
    ...
    const { name, email, token, isAuthorization, logout } = useAuth()
    const { getCart, countofproducts } = useCart()
    ...
    return (
        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a onClick={() => navigate("/")} className="flex hover:cursor-pointer items-center space-x-3 rtl:space-x-reverse">
                    ...
                    {isAuthorization ? (
                        <>
                            <div className="relative flex items-center">
                                <div onClick={() => navigate("/cart")} className="mr-8 relative hover:cursor-pointer">
                                    <i className="fa-jelly-duo fa-regular fa-cart-shopping text-2xl" />
                                ...
                                {open && (
                                    <div className="absolute top-full right-0 z-50 w-48 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <button onClick={() => { navigate("/login") }} type="button" className="text-white hover:cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Login</button>
                    }
